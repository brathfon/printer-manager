...
CREATE TABLE IF NOT EXISTS `printers` (
  ...
  `name` VARCHAR(45) NULL COMMENT 'Probably not going to use this.',
...
CREATE TABLE IF NOT EXISTS `color_levels` (
  ...
  `level` INT NULL COMMENT 'Percent full',
  PRIMARY KEY (`printer_id`, `when`, `color`),
